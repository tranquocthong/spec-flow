  ...
  'init-project'(args) {
    ...
    if (fs.existsSync(PATHS.config)) {
      ...
      if (!existingCfg.phase) {
        existingCfg.phase = { confirmTasks: true, taskNotes: false };
        dirty = true;
      } else if (existingCfg.phase.taskNotes === undefined) {
      ...
      const config = {
        ...
        phase: { confirmTasks: true, taskNotes: false },
