...
module.exports = {
  ...
  'trace-build'(args) {
    ...
    const sectionMismatchWarning = (numRe, label, contentTable, expectedHeaders) => {
    ...
    for (const w of [
      ...
      sectionMismatchWarning(/^10\.4\b/, 'SD §10.4 state table', stateTable, 'headers containing "State" and "Meaning"'),
